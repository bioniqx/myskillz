...
3. Test each guard in isolation: bypass layer 1 (call layer 2 directly, or through a mock) and confirm layer 2 catches it. These tests are independent → run them in parallel.
